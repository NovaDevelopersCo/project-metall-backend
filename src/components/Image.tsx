...
const ImageLoader = ({ isLoading }: { isLoading: boolean }) => {
  return (
    ...
    >
      <path d="M12 3L12 6" stroke="#d1d1d3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M21 12L18 12" stroke="#d1d1d3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M12 21L12 18" stroke="#d1d1d3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M3 12L6 12" stroke="#d1d1d3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path
